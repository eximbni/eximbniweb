...
._1Plpp {
    ...
    will-change: width;
        ...
        <div class="container-fluid ganesh h-100">
			<div class="row h-100">
...
<!--								<div class="video_cam">
								   ...
								   <span class="attach_filp_btn" ><i class="fas fa-paperclip"></i></span> 
							</div>
...
<!--								<div class="img_cont_msg">
							...
							<div class="d-flex justify-content-end mb-4">
								<div class="msg_cotainer_send">
									Hi Ashok i am good tnx how about you?
...
<!--								<div class="input-group-append">
								...
								<input type="text" name="" class="form-control _1Plpp" placeholder="Type your message..."> 
								<div class="input-group-append">
									<span class="input-group-text send_btn"><i class="fas fa-microphone" style="color: #919191;"></i></span>
