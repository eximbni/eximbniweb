        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">My Purchase Details</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="sell">
                    <div class="card-body">
                            ...
                            <div class="row col-lg-12 col-xs-12 col-sm-12 col-md-12" ng-repeat="selllead1 in purchasesellleads | filter:sellsearch" ng-if="purchasesellleads != 0"> 
                          	...
                          	<div class="form-group col-lg-12 col-xs-12 col-sm-12 col-md-12 card-row" style="color:#000;  text-align:left;">
                          		<div  class="row col-lg-12 col-xs-12 col-sm-12 col-md-12" style="background: #fff; color: rgb(243, 93, 93); border-bottom: 1px solid grey;">
                          		    ...
                          		    <div class="col-5">
                           		    ...
                           		    <div class="col-2">
                          		       <button type="button" class="btncls1 btn-primary" ng-click="view_mypurchaseselllead(selllead1.id)">View</button> 
                          		    </div>
                          		</div>
								...
								<div  class="row form-group col-lg-12 col-xs-12 col-sm-12 col-md-12"> 
                      		      <div class="col-6"><b style="color:#ffa500;" >Import Policy : &nbsp;</b><button type="button" class="btncls1" ng-click="import_policy(selllead1.hsn_id,blead.country_id)"style="background-color: #DAA520; color:#fff;" >View</button></div>
                      		      <div class="col-6"><b style="color:#ffa500;" >Export Policy : &nbsp;</b><button type="button" class="btncls1" ng-click="export_policy(selllead1.hsn_id,blead.country_id)"style="background-color: #DAA520; color:#fff;" >View</button></div>                     		
                      		  </div>
                          	</div>                          	
                            ...
                            <div class="row col-lg-12" ng-if="purchasesellleads <= 0">
                  ...
                  <div class="tab-pane" id="buy">
					<div class="card-body">
                            ...
                            <div class="row col-lg-12 col-xs-12 col-sm-12 col-md-12" ng-repeat="blead in purchasebuyleads | filter:buysearch" ng-if="purchasebuyleads != 0"> 
                          	...
                          	<div class="form-group col-lg-12 col-xs-12 col-sm-12 col-md-12 card-row" style="color:#000;  text-align:left;">
                          		<div  class="row col-lg-12 col-xs-12 col-sm-12 col-md-12" style="background: #fff; color: rgb(243, 93, 93); border-bottom: 1px solid grey;">
                          		    ...
                          		    <div class="col-5">
                           		    ...
                           		    <div class="col-2">
                          		       <button type="button" class="btncls1 btn-primary" ng-click="view_mypurchasebuylead(blead.id)">View</button> 
                          		    </div>
                          		</div>
                          		<div  class="row form-group col-lg-12 col-xs-12 col-sm-12 col-md-12">
                          	...
                          	<div class="clearfix"> </div>
                            <div class="row col-lg-12" ng-if="purchasebuyleads == 0">
                                <div  class=" form-group col-lg-12 col-xs-12 col-sm-12 col-md-12"> <!-- style="color:#488aff" -->
                              		<div class="col-lg-12 col-xs-12 col-sm-12 col-md-12 text-danger" align="center" >  <strong> No records found.</strong> </div>
                              	</div> 
