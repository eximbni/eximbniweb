      ...
      <div class="container-fluid">
        ...
        <div class="card card-outline">
          <div class="card-header" style="background: #ff0000b0; color: #ffffff;">
            <h3 class="card-title" align="center" >Notification</h3>
          </div>
          <!-- /.card-header -->
            ...
            <div class="col-md-12 card-row" ng-repeat="usernotify in usernotification | orderBy : id : false" >
                <div class="row col-12">
                     <label style="color:#0e0e0ec9">{{ usernotify.title }}</label>
                      <span class="fdate" style="color:#0e0e0ec9">  {{ usernotify.created }}</span> 
                </div>
                <div class="row col-12 card-text" style="color:#0e0e0ec9;text-align: left;">
