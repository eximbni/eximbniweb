            ...
            <div class="row">
                ...
                <div class="wrapper">
                    ...
                    <div class="container main-home-page-style mt30">
                        <div class="row">
                            <div class="home-main col-md-12 col-sm-12 col-xs-12 main-contant-right">
                    ...
                    <div class="container main-home-page-style mt30" >
          <h3 style="background:#f15822; color:#fff; text-align:center; margin-bottom:15px; border-radius:15px; margin-left:70px; margin-right:70px;">About US </h3>
