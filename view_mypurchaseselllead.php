                ...
                <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                      ...
                      <li class="breadcrumb-item active">Seller Purchase Lead</li>
                    </ol>
                  </div>
                  <!-- /.col -->
                </div>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-success card-outline" >
          <div class="card-header">
            <h3 class="card-title">Seller Purchase Lead Details</h3>
          ...
          <div class="card-body table-responsive">
            ...
            <tbody >
              ...
              <tr scope="row"  >
                ...
                <td scope="col"> {{ pursesell.name }} </td>
                <th scope="col" > <label > Email Id : </label> </th>                
                <td scope="col" > {{ pursesell.email }} </td>
                <th scope="col" > <label > Lead Posted from Country : </label> </th> 
                <td scope="col"> {{ pursesell.countryname }} </td>                
              </tr>           
              <tr scope="row"  >
                <th scope="col"> <label > Valid From : </label> </th>
                <td scope="col"> {{ pursesell.posted_date }} </td>
                <th scope="col" > <label > To : </label> </th>                
                <td scope="col" > {{ pursesell.expiry_date }} </td>
                <th scope="col" > <label > Reference Id : </label> </th> 
                <td scope="col"> {{ pursesell.leadref_id }} </td>
              </tr>
              <tr>
                <th > <label > Chapter : </label> </th> 
                <td > {{ pursesell.chapter_id }} </td>
                <th > <label > Quantity : </label> </th> 
                <td > {{ pursesell.quantity+" "+pursesell.uom }} </td>
                <td colspan="2">
                  <button type="button" class="col-4 btn btn-success" ng-click="add_chat(pursesell.users_id)"> Chat </button>
                </td>                
<!--                 <th > <label > Country : </label> </th> 
                <td > {{ pursesell.country}} </td>    -->                
               </tr>
              <tr>
                <th> <label > Business Name  : </label> </th> 
                <td colspan="5"> {{ pursesell.business_name }} </td>
                                  
               </tr>               
              <tr >  
                <th > <label > Lead Description  </label> </th> 
                <td colspan="5"> {{ pursesell.description }} </td>
              </tr> 
              <tr align="center">  
              ...
              <tr ng-if="!(purrespsellleads==0)">  
                <td colspan="6" >
                  ...
                  <table class="table table-borderless" width="100%" border="1" ng-repeat="respons in purrespsellleads">
                    <tbody >
